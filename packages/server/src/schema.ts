...
export class SchemaManager {
    ...
    public static configure(): SchemaConfiguration[] {
        ...
        const entity_manifests: SchemaConfiguration[] = [
            {
                fileMatch: ["weapon.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-weapon-schema.json")).toString(),
            },
            {
                fileMatch: ["unit_skin.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-unit-skin-schema.json")).toString(),
            },
            {
                fileMatch: ["unit_item.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-unit-item-schema.json")).toString(),
            },
            {
                fileMatch: ["unit.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-unit-schema.json")).toString(),
            },
            {
                fileMatch: ["start_mode.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-start-mode-schema.json")).toString(),
            },
            {
                fileMatch: ["research_subject.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-research-subject-schema.json")).toString(),
            },
            {
                fileMatch: ["player.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-player-schema.json")).toString(),
            },
            {
                fileMatch: ["npc_reward.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-npc-reward-schema.json")).toString(),
            },
            {
                fileMatch: ["formation.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-formation-schema.json")).toString(),
            },
            {
                fileMatch: ["flight_pattern.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-flight-pattern-schema.json")).toString(),
            },
            {
                fileMatch: ["exotic.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-exotic-schema.json")).toString(),
            },
            {
                fileMatch: ["buff.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-buff-schema.json")).toString(),
            },
            {
                fileMatch: ["action_data_source.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-action-data-source-schema.json")).toString(),
            },
            {
                fileMatch: ["ability.entity_manifest"],
                uri: pathToFileURL(path.join(schemasPath_dev, "entity-manifest-ability-schema.json")).toString(),
            },
        ];
